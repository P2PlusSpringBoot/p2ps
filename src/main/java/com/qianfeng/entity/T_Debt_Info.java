...
public class T_Debt_Info implements Serializable{
    ...
    private String d_debt_ransfer_out_date;//债权转出日期
    ...
    private String d_loan_end_date;//原始借款到期日期
    private BigDecimal d_loan_period;//原始借款期限
    private String d_loan_purpose;//借款用途
    private String d_loan_start_date;//原始借款开始日期
    ...
    public String getD_debt_ransfer_out_date() {
        return d_debt_ransfer_out_date;
    }

    public void setD_debt_ransfer_out_date(String d_debt_ransfer_out_date) {
    ...
    public String getD_loan_end_date() {
        return d_loan_end_date;
    }

    public void setD_loan_end_date(String d_loan_end_date) {
    ...
    public String getD_loan_start_date() {
        return d_loan_start_date;
    }

    public void setD_loan_start_date(String d_loan_start_date) {
...
/* BigDecimal  String  String
   ...
   D_DEBT_RANSFER_OUT_DATE Stringtamp comment '债权转出日期',
   D_DEBT_STATUS        numeric(10,0) comment '债权状态',
   D_DEBT_STATUS_NAME   varchar(255) comment '债权状态名字',
   D_DEBT_TRANSFERRED_DATE Stringtamp comment '债权转入日期',
   ...
   D_LOAN_END_DATE      Stringtamp comment '原始借款到期日期',
   D_LOAN_PERIOD        numeric(10,0) comment '原始借款期限',
   D_LOAN_PURPOSE       varchar(255) comment '借款用途',
   D_LOAN_START_DATE    Stringtamp comment '原始借款开始日期',
